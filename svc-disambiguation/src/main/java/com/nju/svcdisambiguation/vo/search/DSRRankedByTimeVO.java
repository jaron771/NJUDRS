...
public class DSRRankedByTimeVO implements Comparable{
    private int docId;
    private String db;
    ...
    public DSRRankedByTimeVO() {
        authors = new ArrayList<>();
    }

    public DSRRankedByTimeVO(int docId, String db, String title, String abs, ArrayList<AuthorSearchResultVO> authors, int citations, int year, String keywords, String publication) {
        this.docId = docId;
        this.db = db;
        this.title = title;
        this.abs = abs;
    ...
    public DSRRankedByTimeVO(DocumentSearchResultVO documentSearchResultVO){
    ...
    public int compareTo(Object o) {
        DSRRankedByTimeVO dsrRankedByTimeVO = (DSRRankedByTimeVO)o;
        return (Integer.compare(this.getCitations(), dsrRankedByTimeVO.getCitations()));
    }
